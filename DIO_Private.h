...
#define DIO_PRIVATE_H_
	...
	#ifndef DDRE
	#define DDRE   (*(uint8*) 0x2D)
	#endif
	
	#ifndef DDRF
	#define DDRF   (*(uint8*) 0x30)
	#endif
	
	#ifndef DDRG
	#define DDRG   (*(uint8*) 0x33)
	#endif
	
	#ifndef DDRH
	#define DDRH   (*(uint8*) 0x101)
	#endif
	
	#ifndef DDRJ
	#define DDRJ   (*(uint8*) 0x104)
	#endif
	
	#ifndef DDRK
	#define DDRK   (*(uint8*) 0x107)
	#endif
	
	#ifndef DDRL
	#define DDRL   (*(uint8*) 0x10A)
	#endif
